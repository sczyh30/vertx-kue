...
*/
public class KueServiceVertxEBProxy implements KueService {
  ...
  public KueServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public KueServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
