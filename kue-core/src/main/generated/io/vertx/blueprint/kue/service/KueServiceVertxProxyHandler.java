...
*/
public class KueServiceVertxProxyHandler extends ProxyHandler {
  ...
  public KueServiceVertxProxyHandler(Vertx vertx, KueService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public KueServiceVertxProxyHandler(Vertx vertx, KueService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public KueServiceVertxProxyHandler(Vertx vertx, KueService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
